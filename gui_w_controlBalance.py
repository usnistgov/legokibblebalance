...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.TB_analogOutput = QtGui.QDoubleSpinBox(self.groupBox)
        self.TB_analogOutput.setFrame(True)
        self.TB_analogOutput.setAlignment(QtCore.Qt.AlignCenter)
        self.TB_analogOutput.setButtonSymbols(QtGui.QAbstractSpinBox.PlusMinus)
        ...
        self.LCD_analogOutput = QtGui.QLCDNumber(self.groupBox)
