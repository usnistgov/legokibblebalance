...
class Ui_w_pathsAndVariables(object):
    def setupUi(self, w_pathsAndVariables):
        ...
        self.centralwidget = QtGui.QWidget(w_pathsAndVariables)
        ...
        self.CB_defaultFolder = QtGui.QCheckBox(self.groupBox)
        ...
        self.CB_diffrentFolder = QtGui.QCheckBox(self.groupBox)
        ...
        self.TEXT_Path = QtGui.QLineEdit(self.groupBox)
        ...
        self.TB_Armlength = QtGui.QDoubleSpinBox(self.groupBox_2)
        ...
        self.TB_Resistance = QtGui.QDoubleSpinBox(self.groupBox_2)
        ...
        self.TB_little_g = QtGui.QDoubleSpinBox(self.groupBox_2)
        ...
        self.TB_AcceptablePositionDeviation = QtGui.QDoubleSpinBox(self.groupBox_2)
        ...
        self.BTN_saveRestart = QtGui.QPushButton(self.centralwidget)
